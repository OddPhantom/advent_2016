...
for initial_pwd in itertools.permutations(letters, 8):

    initial_pwd = list(initial_pwd)
    result = process(initial_pwd, data)
    #print "{}:{}".format(initial_pwd, result)
    if result == "fbgdceah":
        print "password is {}".format("".join(initial_pwd))
        break
